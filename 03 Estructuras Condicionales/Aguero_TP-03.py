...
# cuando la media es mayor que la mediana
# y, a su vez, la mediana es mayor que la moda.
# ● Sesgo negativo o a la izquierda: (media < mediana < moda)
# cuando la media es menor que la mediana
# y, a su vez, la mediana es menor que la moda.
# ● Sin sesgo: cuando la media, la mediana y la moda son iguales. (media = mediana = moda)
